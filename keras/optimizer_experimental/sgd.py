...
class SGD(optimizer.Optimizer):
  ...
  Attributes:
    ...
    gradients_clip_option: an instance of
      `optimizer_experimental.GradientsClipOption`. Attributes related to
      gradients clipping, such as clipnorm and clipvalue.
    ema_option: an instance of `optimizer_experimental.EMAOption`. Attributes
      related to exponenatial moving average, such as use_ema (a boolean
      field indicates if EMA is used) and EMA momentum. Please refer to
      `optimizer_experimental.EMAOption` for more information.
